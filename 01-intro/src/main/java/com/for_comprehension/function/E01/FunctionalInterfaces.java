...
final class FunctionalInterfaces {
    ...
    /**
     * @return a higher-ord
     * er function that takes an integer and returns a predicate validating if the input is bigger than the provided value
     */
    ...
    static <T> BinaryOperator<Function<T, T>> L8_functionComposition2() {
        return (f1, f2) -> {
            return t -> {
                ...
                var result = f2.apply(partial);
                return result;
            };
        };
    }

    static <T> BinaryOperator<Function<T, T>> L8_functionComposition3() {
